...
class Song extends Model implements HasMedia
{
    ...
    protected $appends = ['artwork_url', 'artists', 'display_artists', 'royalti','royalti_detail','unconfirm_detail' , 'permalink_url', 'stream_url', 'favorite', 'library', 'streamable', 'allow_download', 'allow_high_quality_download'];
