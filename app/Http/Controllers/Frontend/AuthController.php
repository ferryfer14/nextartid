...
class AuthController
{
    ...
    public function login()
    {
        ...
        /** IF LOGIN IS SUCCESS LETS CREATE JWT
         * SANI Code Stats here
         *
         */
        
        date_default_timezone_set('Asia/Jakarta');
        $now = time();
        /** Data to generate JWT **/
        $payload = [
            'exp' 			=> $now + 1500005,
            'iat' 			=> $now,
            'jti' 			=> md5(($now) . mt_rand()),
    ...
    public function generate_jwt($payload, $key, $alg = 'HS256', $keyId = null, $head = null)
    {
        ...
        $segments = array();
        $segments[] = $this->urlsafeB64Encode(static::jsonEncode($header));
        $segments[] = $this->urlsafeB64Encode(static::jsonEncode($payload));
