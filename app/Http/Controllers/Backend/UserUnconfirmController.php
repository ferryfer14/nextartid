...
class UserUnconfirmController
{
    ...
    public function index()
    {
        ...
        return view('backend.user-unconfirm.index')
            ->with('term', $term)
            ->with('users', $user);
    }
    ...
    public function album()
    {
        ...
        return view('backend.user-unconfirm.album')
            ->with('term', $term)
            ->with('albums', $album)
    ...
    public function song()
    {
        ...
        return view('backend.user-unconfirm.song')
            ->with('term', $term)
            ->with('songs', $song)
    ...
    {
        $royalti = RoyaltiUnconfirm::withoutGlobalScopes()->selectRaw('SUM(value) as value, patner')->where('song_id', $this->request->route('id'))->groupBy('patner');
        ...
        return view('backend.user-unconfirm.song-detail')
            ->with('term', $term)
