(function (factory) {
    ...
    window.Artist = {
        ...
        withdrawRoyalti: function(el){
            ...
            Artist.withdrawForm.ajaxForm({
                ...
                success: function (response, textStatus, xhr, $form) {
                    ...
                    $form.trigger("reset");
                    $.engineLightBox.hide();
                    Toast.show("success", Language.text.POPUP_REQUEST_WITHDRAW);
                    $(window).trigger({
                        type: "engineReloadCurrentPage"
                    });
                },
        ...
        royaltiArtist: function (artist) {
            ...
            console.log(artist);
            $('#detail-royalti > tbody').html('');
            artist.royalti.forEach(function(s) {
                $('#detail-royalti > tbody:last-child').append('<tr class="module" data-toggle="contextmenu" data-trigger="right" data-type="royalti" data-id="'+s.id+'">'+
                '<td class="text-left desktop">'+s.patner+'</td>'+
        ...
        createAlbum: function () {
            ...
            $('#create-album-form').ajaxForm({
                ...
                success: function (response, textStatus, xhr, $form) {
                    ...
                    window.location.href = "/artist-management/albums/"+response.id+"/upload";
                    $(window).trigger({
                        type: "engineReloadCurrentPage"
                    });
                },
