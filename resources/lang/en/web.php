...
return [
    ...
    "UPLOAD_ALL_FORMAT_TIP" => "Only 44.1KHz 16bit/24bit or  48KHz 16bit/24bit in WAV format accepted",
    "UPLOAD_MP3_TIP" => "Browse for wav files to upload or drag and drop them here",
    ...
    "ALBUMS" => "Albums",
    "ALBUMS_ALL" => "All",
    "ALBUMS_UNPAID" => "Unpaid",
    "ALBUMS_PAID" => "Paid",
    "ALBUMS_RELEASE" => "Today Release(s)",
    "ARTIST" => "Artist",
    "ARTISTS" => "Artists",
    "VIDEOS" => "Videos",
    ...
    "TOOLTIP_WITHDRAW_FAILED" => "You have to reach the minimum balance to be able process a withdraw. Minimum balance is $100",
    ...
    "POPUP_REQUEST_WITHDRAW_BALANCE" => "Your withdraw, has been successfully created. Please wait 1x24 hours",
    ...
    "FORM_ARTIST1" => "Artist Name 1:",
    "FORM_ARTIST2" => "Artist Name 2:",
    ...
    "FORM_SOUNDCLOUD_LINK" => "SoundCloud profile url:",
    ...
    "FORM_GENRES3" => "(*)Local Genre:",
    "FORM_LANGUAGE" => "Language:",
    "FORM_ALBUM_VERSION" => "Remix or Version (optional):",
    "FORM_ISRC_CODE" => "ISRC code:",
    "FORM_ISWC_CODE" => "ISWC code:",
    "FORM_START_POINT_TIME" => "Start Point Time (TikTok):",
    "FORM_UPC_CODE" => "Release UPC code:",
    "FORM_REF_CODE" => "Reference Number:",
    "FORM_GRID_CODE" => "Global Release Identifier (GRid) (optional):",
    "FORM_RELEASE_NOTE" => "Release description (Liner Notes) (optional):",
    "FORM_NOTE" => "Notes (optional):",
    "FORM_PRICE_CATEGORY" => "Price Category:",
    "FORM_LICENSE_HOLDER" => "License Holder:",
    "FORM_LICENSE_RECORDINGS" => "(P) copyright for sound recordings:",
    "FORM_PUBLISHING" => "(P) Publishing rights:",
    "FORM_TERRITORIES" => "Territories:",
    "FORM_LYRIC" => "Lyric (optional):",
    "FORM_SEPARATELY" => "Available separately (optional):",
    "FORM_MOODS" => "Mood(s):",
    "FORM_TAGS" => "Tag(s):",
    "FROM_DEFAULT_GENRE" => "Genre(s):",
    "FROM_DEFAULT_MOOD" => "Mood(s):",
    "FROM_DEFAULT_ARTIST" => "Artist(s) Role:",
    ...
    "ARTIST_PROFILE_PICTURE" => "Profile picture",
    "FORM_ARTIST_BAND_NAME" => "Your Name",
    "FORM_GENRE" => "Genre(s):",
    "FORM_MOOD" => "Mood(s):",
    "FORM_TYPE" => "(*)Album Type:",
    "FORM_RELEASED_AT" => "Original release date:",
    ...
    "FORM_SCHEDULE_PUBLISH" => "Digital Release date:",
    ...
    "FORM_BANK" => "Bank Name:",
    "FORM_BANK_OTHER" => "Another Bank Name:",
    "FORM_BANK_ACCOUNT_NAME" => "Bank Account Name:",
    "FORM_BANK_ACCOUNT" => "Bank Account Number:",
    "FORM_VALUE" => "Confirmed Royalty ($):",
    "NEXT_SONG" => "Next Song",
    "PREV_SONG" => "Prev Song",
    ...
    "MP3_ONLY_ALLOWED" => "WAV files, at least 44.1Khz 16bit allowed.",
    ...
    "UPLOAD_ERROR_FILE_TYPE" => "Incorrect file type. Only WAV's are supported.",
