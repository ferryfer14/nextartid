...
<div id="lightbox-outer">
                                ...
                                <div class="control-group col-lg-6 col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 d-flex">
                                            <input class="hide custom-checkbox" type="checkbox" name="show-password" id="show-password" value="O">
    ...
    <div class="lightbox lightbox-royalti-artist-unconfirm hide">
        <div class="lbcontainer">
            <div id="royalti-unconfirm">
                <div class="lightbox-header">
                    <h2 class="title">Detail Royalti Unconfirm</h2>
    ...
    <div class="lightbox lightbox-royalti-artist-song hide">
        <div class="lbcontainer">
            <div id="upload-song">
                <div class="lightbox-header">
                    <h2 class="title">Detail Royalti Confirm</h2>
                    ...
                    <div class="lightbox-content">
                        <div class="lightbox-content-block">
                            ...
                            <div class="song-info-container">
                                ...
                                <div class="control field">
                                    <label>
                                        <span data-translate-text="{{ __('FORM_ALBUM_VERSION') }}">{{ __('FORM_ALBUM_VERSION') }}</span>
                                    </label>
                                ...
                                <div class="control field">
                                    <label for="isrc-code">
                                        <span data-translate-text="FORM_ISRC_CODE">{{ __('FORM_ISRC_CODE') }}</span>
                                    </label>
                                ...
                                <div class="control field">
                                    <label for="iswc-code">
                                        <span data-translate-text="FORM_ISWC_CODE">{{ __('FORM_ISWC_CODE') }}</span>
                                    </label>
                                ...
                                <div class="control field">
                                        <label>
                                            <span data-translate-text="FORM_NOTE">{{ __('FORM_NOTE') }}</span>
                                        </label>
                                        <textarea type="text" name="description" maxlength="180"></textarea>
                                    </div>
                                <!--<div class="control field">-->
    ...
    <div class="lightbox lightbox-withdraw-royalti hide">
        <div class="lbcontainer">
            <div id="create-playlist">
                <form id="withdraw-form" class="ajax-form" method="post" action="{{ route('frontend.auth.user.artist.manager.convert.royalti') }}" enctype="multipart/form-data" novalidate>
                    <div class="lightbox-header">
                        <h2 class="title" data-translate-text="POPUP_WITHDRAW">{{ __('web.POPUP_WITHDRAW') }}</h2>
                        @yield('lightbox-close')
                    </div>
                                ...
                                <div class="input-container">
                                    ...
                                    <div class="control field" mb-0>
                                        <div class="row">
                                         ...
                                         <div id="additional_artist_album">
                                         </div>
                                    </div>
                                    <div class="control field">
                                        <label>
                                    ...
                                    <div class="control field">
                                        <label for="upc-code">
                                            <span data-translate-text="FORM_UPC_CODE">{{ __('FORM_UPC_CODE') }}</span>
                                        </label>
                                        <input name="upc" type="text" readonly>
                                        <input name="upc-code" type="checkbox" checked="checked">
                                        I don't have one, assign a UPC code to this release automatically
                                    </div>
                                    <div class="control field">
                                        <label for="ref-code">
                                            <span data-translate-text="FORM_REF_CODE">{{ __('FORM_REF_CODE') }}</span>
                                        </label>
                                        <input name="ref" type="text" readonly>
                                        <input name="ref-code" type="checkbox" checked="checked">
                                        I don´t have one, please assign a reference number code to this release                                        
                                    </div>
                                    <div class="control field">
                                        <label for="grid-code">
                                            <span data-translate-text="FORM_GRID_CODE">{{ __('FORM_GRID_CODE') }}</span>
                                        </label>
                                        <input name="grid-code" type="text">
                                    </div>
                                    <!--<div class="control field">-->
                                    <!--    <label>-->
                                    ...
                                    <div class="control field">
                                        <label>
                                            <span data-translate-text="FORM_RELEASE_NOTE">{{ __('FORM_RELEASE_NOTE') }}</span>
                                        </label>
                                        <textarea type="text" name="description" maxlength="180"></textarea>
                                    </div>
                                    <!--<div class="control field">
                                    ...
                                    <div class="control field d-none">
                                        ...
                                        <input name="copyright" type="text" value="Copyright" readonly>
                                    </div>
                                    <div class="control field" mb-0>
                                        <label for="artist-job">
                                            <span data-translate-text="FORM_LICENSE_HOLDER">{{ ('FORM_LICENSE_HOLDER') }}</span>
                                        </label>
                                        <div class="row">
                                            <div class="col-md-3">
                                    ...
                                    <div class="control field" mb-0>
                                        <label for="license-recording">
                                            <span data-translate-text="FORM_LICENSE_RECORDINGS">{{ ('FORM_LICENSE_RECORDINGS') }}</span>
                                        </label>
                                        <div class="row">
                                            <div class="col-md-3">
