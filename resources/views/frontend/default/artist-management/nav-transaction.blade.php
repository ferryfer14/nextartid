<div id="page-nav">
    <div class="outer">
        <ul>
            ...
            <li><a href="{{ route('frontend.auth.user.artist.manager.subscribe') }}" class="page-nav-link @if(Route::currentRouteName() == 'frontend.auth.user.artist.manager.subscribe') active @endif">Subscribe<div class="arrow"></div></a></li>
