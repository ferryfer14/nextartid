    ...
    @foreach ($transaction as $trx)
        @if(isset($trx->payments))
            <tr class="module" data-toggle="contextmenu" data-trigger="right" data-type="transaction" data-id="{{ $trx->id }}">
                ...
                <td>
                    <a class="btn options" target="_blank" href="{{ route('frontend.auth.user.artist.manager.albums.invoice', ['id' => $trx->id]) }}" data-toggle="contextmenu" data-trigger="left" data-type="song" data-id="{{ $trx->id }}">
