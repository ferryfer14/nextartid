            ...
            <div class="page-header artist-management main">
                ...
                <div class="inner">
                    ...
                    <ul class="stat-summary">
                        <li><a class="basic-tooltip" tooltip="Total Royalties that have been generated"><span class="num">${{ round($artist->balance_confirm,3)-round($artist->sum_withdraw,3) }}</span><span class="label" data-translate-text="BALANCE">{{ __('web.BALANCE') }}</span></a></li>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6 col-6 mb-4">
                        <div class="card o-hidden h-100 shadow artist">
                            <div class="card-body">
                                ...
                                <p class="d-block text-center font-weight-bold mt-0">Unconfirmed Royalty</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-sm-6 col-6 mb-4">
                        <div class="card o-hidden h-100 shadow artist">
                            <div class="card-body">
                                ...
                                <p class="d-block text-center font-weight-bold mt-0">Points Reward</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-sm-6 col-6 mb-4">
