        ...
        <div class="card">
            <div class="card-body">
                <div class="col-12">
                    <div class="row p-1">
                        <div class="col-6">
                            <p class="font-weight-bold mb-1">Invoice Subscribe #{{ 'NEX'.$transaction->transaction_id }}</p>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-0 text-uppercase small font-weight-bold">Time Period</th>
                ...
                <div class="d-flex flex-row-reverse bg-dark text-white">
                    ...
                    <div class="py-3 px-5 text-right">
                        ...
                        <div class="h4 text-success font-weight-light">Rp {{ number_format((float)($transaction->amount), 0, ',', '.') }}</div>
                    </div>
                </div>
            </div>
        </div>
