        ...
        <div class="card-header py-3 border-1">
            <div class="row align-items-center" data-id="{{$album->id}}">  
                ...
                <div class="col-sm-2">   
                    ...
                    <h4 class="m-0 font-weight-bold text-primary">{{ round($album->upc) }}</h4>                 
                </div>
                <div class="col-sm-2">   
                ...
                <div id="collapseOne{{ $album->id }}" class="collapse p-4" aria-labelledby="headingOne" data-parent="#collapseMetaTags">
                    ...
                    <table class="table artist-management">
                        ...
                        <tr>
                            ...
                            <th class="desktop">Royalty Confirm</th>
                            <th class="desktop">Royalty Unconfirm</th>
                        ...
                        <tbody>
                            @foreach ($album->song as $index => $song)
                                <tr class="module" data-toggle="contextmenu" data-trigger="right" data-type="song" data-id="{{ $song->id }}">
                                    ...
                                    <td class="text-center desktop">${{ round($song->sum_unconfirm,3) }}</td>
                                    <td class="text-right secondary-actions-container">
                                        <div class="row-actions secondary align-items-stretch">
                                            <a class="btn options song-royalti basic-tooltip" tooltip="Detail Royalti Confirm" data-type="song" data-id="{{ $song->id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash" viewBox="0 0 16 16">
                                                    <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
                                                    <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2H3z"/>
                                                </svg>
                                            </a>
                                            <a class="btn options unconfirm-royalti basic-tooltip" tooltip="Detail Royalti Unconfirm" data-type="song" data-id="{{ $song->id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash" viewBox="0 0 16 16">
                                                    <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
                                                    <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2H3z"/>
                                                </svg>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 border-1">
                        <div class="row align-items-center">  
                            ...
                            <div class="col-sm-2">   
                                <!--<p class="text-secondary">UPC</p>-->
                                <h4 class="m-0 font-weight-bold text-primary">UPC</h4>                 
                            </div>
                            <div class="col-sm-2">   
                                <!--<p class="text-secondary">Royalty</p>-->
                                <h4 class="m-0 font-weight-bold text-primary">Confirm</h4>                 
                            </div>
                            <div class="col-sm-2">   
                                <!--<p class="text-secondary">Royalty</p>-->
