                            ...
                            <div class="card {{$album->paid == 1 ? 'd-none' : ''}}">
                                <div class="m-2">
                                    @if($album->user->album_pay == 0)
                                        ...
                                        @endif
                                    @else
                                        <p class="d-flex justify-content-center">You are a Subscription User, you don't need to pay for this album. Just click pay and this album can be published.</p>
                                        <a data-type="pay" data-id="{{ $album->id }}" class=" w-100 btn {{ $album->song_count*$album->price->harga_discount == 0 ? 'btn-secondary' : 'pay btn-primary' }}">Pay Now</a>
