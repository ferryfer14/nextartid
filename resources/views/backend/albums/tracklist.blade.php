...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('backend.albums.edit', ['id' => $album->id]) }}">{!! $album->title !!}</a> - @foreach($album->artists as $artist)<a href="{{ route('backend.albums.edit', ['id' => $artist->id]) }}" title="{!! $album->primary_artist !!}">{!! $album->primary_artist !!}</a>@if(!$loop->last), @endif @endforeach</li>
        ...
        <div class="col-lg-12 media-info mb-3 album">
            <div class="media mb-3">
                ...
                <div class="media-body">
                    <h5 class="m-0">{!! $album->title !!} - @foreach($album->artists as $artist)<a href="{{ route('backend.artists.edit', ['id' => $artist->id]) }}" title="{!! $album->primary_artist !!}">{!! $album->primary_artist !!}</a>@if(!$loop->last), @endif @endforeach</h5>
