...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('backend.user.unconfirm.album', ['id' => $album_id, 'artist_id' => $artistIds]) }}">Song Unconfirm Royalti</a></li>
        <li class="breadcrumb-item active">Songs Detail Unconfirm Royalti</li>
    </ol>
    <div class="row">
        <div class="col-lg-12">
